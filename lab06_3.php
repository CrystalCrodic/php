...
{
  if (preg_match("/^(\(0[1-9]{1,2}\))?[0-9]{7,8}/", $string)) {
    return true;
  }
  return false;
}

function checkNgaySinh($string)
{
  ...
  ?>
    <div class="info">Lỗi<br />
      ...
      if (checkPassword($pwd) == false)
        echo "Định dạng mật khẩu sai!<br>";
      if (checkPhone($phone) == false)
        echo "Định dạng số điện thoại sai!<br>";
      if (checkNgaySinh($date) == false)
        echo "Định dạng số ngày sinh sai!<br>";
      ?>
